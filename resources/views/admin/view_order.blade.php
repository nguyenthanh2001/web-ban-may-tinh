...
<div class="table-agile-info">
  ...
  <div class="text-center panel-heading">
    ...
    <span>
      ...
      <table class="table table-striped b-t b-light">
        ...
        @foreach($order_details as $key => $details)
          ...
          <tr class="color_qty_{{$details->product_id}}">
            ...
            <td><i>{{$i}}</i></td>
            <td style="width: 100px;">{{$details->product_name}}</td>
      ...
      <br>
      <a style="background-color: cornflowerblue; padding:10px; border-radius: 20px; color: #FFFFFF;" target="_blank" href="{{url('/print-order/'.$details->order_code)}}">In đơn hàng</a>
      <br><br><br>
    </div>
