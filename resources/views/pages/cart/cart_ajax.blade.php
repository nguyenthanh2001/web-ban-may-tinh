...
@section('content')
	...
	<section id="cart_items" style="width: 900px;">
		<div class="container">
			...
			<div class="table-responsive cart_info">
				...
				<table class="table table-condensed"  style="width: 900px;">
					<thead>
						<tr class="cart_menu">
							<td style="width: 30px;" class="image">Hình ảnh</td>
							<td style="width: 50px;" class="description">Tên sản phẩm</td>
							<td style="width: 60px;" class="description">SL tồn</td>
							<td style="width: 30px;" class="price">Giá sản phẩm</td>
							<td style="width: 30px;" class="quantity">Số lượng</td>
							<td style="width: 30px;" class="total">Thành tiền</td>
					...
					<tbody>
						...
						<tr>
							...
							<td colspan="4">
								<b><li>Tổng tiền :<span><u>{{number_format($total,0,',','.')}}đ</u></span></li>
								@if(Session::get('coupon'))
								<li>
										...
										@foreach(Session::get('coupon') as $key => $cou)
											...
											@elseif($cou['coupon_condition']==2)
												...
												<p><li>Tổng đã giảm :<h2><b><u>{{number_format($total_coupon,0,',','.')}}đ</u></b></h2></li></p>
											@endif
										@endforeach
