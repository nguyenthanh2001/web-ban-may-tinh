...
Route::get('/login','HomeController@login_home');
Route::get('/login-customer-home','HomeController@login_customer_home');
...
Route::get('add-users','UserController@add_users')->name('trangadduser');
Route::get('all-users','UserController@all_users')->name('trangalluser');
//Route::get('/delete-slide/{slide_id}','SliderController@delete_slide');

Route::get('Delete-users/{email}','UserController@delete_user');//xoa admin
// Route::get('/Delete-users/{email}/profile', function ($id) {
//     //
// })->name('profile');
...
Route::get('/checkout','CheckoutController@checkout')->name('trangthanhtoan');
...
Route::get('/manage-order-atm','CheckoutController@manage_order_atm');
Route::get('/delete-order-atm/{mathanhtoan}','CheckoutController@delete_order_atm');

Route::post('/order-filter','CheckoutController@order_filter');
